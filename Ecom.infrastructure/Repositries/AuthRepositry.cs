...
namespace Ecom.infrastructure.Repositries
{
    public class AuthRepositry : IAuth
    {
        ...
        public AuthRepositry(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, IEmailService emailService, IGenerateToken generateToken, AppDbContext context)
        {
